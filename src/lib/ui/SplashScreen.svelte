    ...
    <div class="container has-text-centered">
      <div class="columns is-vcentered">
        <div class="column is-5">
          <figure class="image">
            <img class="object-fit" src="/cedar_blarney.jpg" alt="Cedar tree at Blarney Castle" />
          </figure>
        </div>
        <div class="column is-6 is-offset-1">
          <h1 class="title is-2 mb-5">
            <span class="icon mr-5"><i class="fas fa-map-marker-alt"></i></span>
            <span class="icon mr-4"><i class="fas fa-tree"></i></span>
            <p>Placemark App</p>
          </h1>
          <h2 class="subtitle is-4 mt-2">Add and discover your favourite trees!</h2>
